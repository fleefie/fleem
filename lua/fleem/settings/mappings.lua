...
function M.vimtex()
	...
	wk.add({
		...
		{ "<leader>lb", "<cmd>VimtexCompile<cr>", desc = "Compile (continuous)", nowait = true, remap = false },
		{ "<leader>lB", "<cmd>VimtexCompileSS<cr>", desc = "Compile", nowait = true, remap = false },
		{ "<leader>lc", "<cmd>VimtexClean<cr>", desc = "Clean", nowait = true, remap = false },
		{ "<leader>ls", "<cmd>VimtexView<cr>", desc = "Forward Search", nowait = true, remap = false },
	})
end
